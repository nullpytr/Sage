...
template <> struct Data::Map<GameData::OwnedCustomizableHorseTack_Reins> : GameData::OwnedCustomizableHorseTack_Reins {
	...
	{ }
};/* Data::Map GameData::OwnedCustomizableHorseTack_Reins close */
