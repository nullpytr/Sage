...
struct GameData::PictureBookData::Enemy_Zonau_BlockMaster_Junior : Tag::Structure {
...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Zonau_BlockMaster_Junior> : GameData::PictureBookData::Enemy_Zonau_BlockMaster_Junior {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Zonau_BlockMaster_Junior close */
