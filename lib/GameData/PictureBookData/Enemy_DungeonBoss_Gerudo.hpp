...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_DungeonBoss_Gerudo> : GameData::PictureBookData::Enemy_DungeonBoss_Gerudo {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_DungeonBoss_Gerudo close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_DungeonBoss_Gerudo::State> { "PictureBookData.Enemy_DungeonBoss_Gerudo.State" };