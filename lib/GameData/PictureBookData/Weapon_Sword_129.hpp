...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Sword_129> : GameData::PictureBookData::Weapon_Sword_129 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Sword_129 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Sword_129::State> { "PictureBookData.Weapon_Sword_129.State" };