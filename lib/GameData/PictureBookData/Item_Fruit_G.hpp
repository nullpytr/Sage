...
template <> struct Data::Structure<GameData::PictureBookData::Item_Fruit_G> : GameData::PictureBookData::Item_Fruit_G {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_Fruit_G close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_Fruit_G::State> { "PictureBookData.Item_Fruit_G.State" };