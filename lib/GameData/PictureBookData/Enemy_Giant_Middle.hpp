...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Giant_Middle> : GameData::PictureBookData::Enemy_Giant_Middle {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Giant_Middle close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Giant_Middle::State> { "PictureBookData.Enemy_Giant_Middle.State" };