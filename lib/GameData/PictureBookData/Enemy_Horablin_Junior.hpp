...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Horablin_Junior> : GameData::PictureBookData::Enemy_Horablin_Junior {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Horablin_Junior close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Horablin_Junior::State> { "PictureBookData.Enemy_Horablin_Junior.State" };