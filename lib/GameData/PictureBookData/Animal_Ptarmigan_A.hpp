...
template <> struct Data::Structure<GameData::PictureBookData::Animal_Ptarmigan_A> : GameData::PictureBookData::Animal_Ptarmigan_A {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Animal_Ptarmigan_A close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Animal_Ptarmigan_A::State> { "PictureBookData.Animal_Ptarmigan_A.State" };