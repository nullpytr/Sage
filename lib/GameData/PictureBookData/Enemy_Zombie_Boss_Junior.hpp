...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Zombie_Boss_Junior> : GameData::PictureBookData::Enemy_Zombie_Boss_Junior {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Zombie_Boss_Junior close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Zombie_Boss_Junior::State> { "PictureBookData.Enemy_Zombie_Boss_Junior.State" };