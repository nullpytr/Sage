...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Drake_Mix> : GameData::PictureBookData::Enemy_Drake_Mix {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Drake_Mix close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Drake_Mix::State> { "PictureBookData.Enemy_Drake_Mix.State" };