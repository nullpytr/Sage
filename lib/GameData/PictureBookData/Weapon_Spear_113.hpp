...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Spear_113> : GameData::PictureBookData::Weapon_Spear_113 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Spear_113 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Spear_113::State> { "PictureBookData.Weapon_Spear_113.State" };