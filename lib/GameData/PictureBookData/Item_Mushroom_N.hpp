...
template <> struct Data::Structure<GameData::PictureBookData::Item_Mushroom_N> : GameData::PictureBookData::Item_Mushroom_N {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_Mushroom_N close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_Mushroom_N::State> { "PictureBookData.Item_Mushroom_N.State" };