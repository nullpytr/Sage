...
template <> struct Data::Structure<GameData::PictureBookData::Animal_Boar_B> : GameData::PictureBookData::Animal_Boar_B {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Animal_Boar_B close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Animal_Boar_B::State> { "PictureBookData.Animal_Boar_B.State" };