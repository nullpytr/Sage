...
template <> struct Data::Structure<GameData::PictureBookData::Animal_Crow_A> : GameData::PictureBookData::Animal_Crow_A {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Animal_Crow_A close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Animal_Crow_A::State> { "PictureBookData.Animal_Crow_A.State" };