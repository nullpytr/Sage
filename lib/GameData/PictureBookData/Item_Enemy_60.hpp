...
template <> struct Data::Structure<GameData::PictureBookData::Item_Enemy_60> : GameData::PictureBookData::Item_Enemy_60 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_Enemy_60 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_Enemy_60::State> { "PictureBookData.Item_Enemy_60.State" };