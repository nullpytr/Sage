...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Zonau_BlockMaster_Middle> : GameData::PictureBookData::Enemy_Zonau_BlockMaster_Middle {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Zonau_BlockMaster_Middle close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Zonau_BlockMaster_Middle::State> { "PictureBookData.Enemy_Zonau_BlockMaster_Middle.State" };