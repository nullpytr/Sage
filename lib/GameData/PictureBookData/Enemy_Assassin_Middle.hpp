...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Assassin_Middle> : GameData::PictureBookData::Enemy_Assassin_Middle {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Assassin_Middle close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Assassin_Middle::State> { "PictureBookData.Enemy_Assassin_Middle.State" };