...
template <> struct Data::Structure<GameData::PictureBookData::Animal_Bear_A> : GameData::PictureBookData::Animal_Bear_A {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Animal_Bear_A close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Animal_Bear_A::State> { "PictureBookData.Animal_Bear_A.State" };