...
template <> struct Data::Structure<GameData::PictureBookData::Animal_LittleBird_E> : GameData::PictureBookData::Animal_LittleBird_E {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Animal_LittleBird_E close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Animal_LittleBird_E::State> { "PictureBookData.Animal_LittleBird_E.State" };