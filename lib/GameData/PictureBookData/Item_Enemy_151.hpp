...
template <> struct Data::Structure<GameData::PictureBookData::Item_Enemy_151> : GameData::PictureBookData::Item_Enemy_151 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_Enemy_151 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_Enemy_151::State> { "PictureBookData.Item_Enemy_151.State" };