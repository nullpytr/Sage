...
template <> struct Data::Structure<GameData::PictureBookData::Item_Enemy_186> : GameData::PictureBookData::Item_Enemy_186 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_Enemy_186 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_Enemy_186::State> { "PictureBookData.Item_Enemy_186.State" };