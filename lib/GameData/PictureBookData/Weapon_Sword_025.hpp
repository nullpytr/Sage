...
struct GameData::PictureBookData::Weapon_Sword_025 : Tag::Structure {
...
};/* Tag::Structure GameData::PictureBookData::Weapon_Sword_025 close */

template <> struct Data::Structure<GameData::PictureBookData::Weapon_Sword_025> : GameData::PictureBookData::Weapon_Sword_025 {
	Enum<State> State;
	
	explicit Structure(Sav& s) : 
		State { s.get<struct State>() }
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Sword_025 close */
