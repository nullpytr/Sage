...
template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Wizzrobe_Fire::State> = murmurhash3::hash("PictureBookData.Enemy_Wizzrobe_Fire.State");