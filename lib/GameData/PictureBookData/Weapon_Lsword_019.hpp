...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Lsword_019> : GameData::PictureBookData::Weapon_Lsword_019 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Lsword_019 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Lsword_019::State> { "PictureBookData.Weapon_Lsword_019.State" };