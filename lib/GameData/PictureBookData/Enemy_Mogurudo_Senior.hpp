...
struct GameData::PictureBookData::Enemy_Mogurudo_Senior : Tag::Structure {
...
};/* Tag::Structure GameData::PictureBookData::Enemy_Mogurudo_Senior close */

template <> struct Data::Structure<GameData::PictureBookData::Enemy_Mogurudo_Senior> : GameData::PictureBookData::Enemy_Mogurudo_Senior {
	Enum<State> State;
	
	explicit Structure(Sav& s) : 
		State { s.get<struct State>() }
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Mogurudo_Senior close */
