...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Lsword_109> : GameData::PictureBookData::Weapon_Lsword_109 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Lsword_109 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Lsword_109::State> { "PictureBookData.Weapon_Lsword_109.State" };