...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Moriblin_Bone_Junior> : GameData::PictureBookData::Enemy_Moriblin_Bone_Junior {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Moriblin_Bone_Junior close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Moriblin_Bone_Junior::State> { "PictureBookData.Enemy_Moriblin_Bone_Junior.State" };