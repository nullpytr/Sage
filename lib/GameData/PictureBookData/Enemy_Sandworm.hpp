...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Sandworm> : GameData::PictureBookData::Enemy_Sandworm {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Sandworm close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Sandworm::State> { "PictureBookData.Enemy_Sandworm.State" };