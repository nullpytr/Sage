...
template <> struct Data::Structure<GameData::PictureBookData::Obj_Mineral_A_01> : GameData::PictureBookData::Obj_Mineral_A_01 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Obj_Mineral_A_01 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Obj_Mineral_A_01::State> { "PictureBookData.Obj_Mineral_A_01.State" };