...
template <> struct Data::Structure<GameData::PictureBookData::Item_PlantGet_E> : GameData::PictureBookData::Item_PlantGet_E {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_PlantGet_E close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_PlantGet_E::State> { "PictureBookData.Item_PlantGet_E.State" };