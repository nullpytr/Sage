...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Lsword_060> : GameData::PictureBookData::Weapon_Lsword_060 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Lsword_060 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Lsword_060::State> { "PictureBookData.Weapon_Lsword_060.State" };