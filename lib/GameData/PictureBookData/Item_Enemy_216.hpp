...
template <> struct Data::Structure<GameData::PictureBookData::Item_Enemy_216> : GameData::PictureBookData::Item_Enemy_216 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Item_Enemy_216 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Item_Enemy_216::State> { "PictureBookData.Item_Enemy_216.State" };