...
template <> struct Data::Structure<GameData::PictureBookData::Animal_Sunazarashi_A> : GameData::PictureBookData::Animal_Sunazarashi_A {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Animal_Sunazarashi_A close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Animal_Sunazarashi_A::State> { "PictureBookData.Animal_Sunazarashi_A.State" };