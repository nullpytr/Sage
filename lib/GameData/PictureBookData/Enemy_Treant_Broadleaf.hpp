...
template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Treant_Broadleaf::State> = murmurhash3::hash("PictureBookData.Enemy_Treant_Broadleaf.State");