...
struct GameData::PictureBookData::Enemy_Moriblin_Dark : Tag::Structure {
...
};/* Tag::Structure GameData::PictureBookData::Enemy_Moriblin_Dark close */

template <> struct Data::Structure<GameData::PictureBookData::Enemy_Moriblin_Dark> : GameData::PictureBookData::Enemy_Moriblin_Dark {
	Enum<State> State;
	
	explicit Structure(Sav& s) : 
		State { s.get<struct State>() }
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Moriblin_Dark close */
