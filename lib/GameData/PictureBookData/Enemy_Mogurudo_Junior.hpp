...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Mogurudo_Junior> : GameData::PictureBookData::Enemy_Mogurudo_Junior {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Enemy_Mogurudo_Junior close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Mogurudo_Junior::State> { "PictureBookData.Enemy_Mogurudo_Junior.State" };