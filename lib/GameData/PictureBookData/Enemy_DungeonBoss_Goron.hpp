...
template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_DungeonBoss_Goron::State> = murmurhash3::hash("PictureBookData.Enemy_DungeonBoss_Goron.State");