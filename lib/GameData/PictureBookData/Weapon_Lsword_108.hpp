...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Lsword_108> : GameData::PictureBookData::Weapon_Lsword_108 {
	...
	{ }
};/* Structure Data::Structure GameData::PictureBookData::Weapon_Lsword_108 close */

template <> hash_value_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Lsword_108::State> { "PictureBookData.Weapon_Lsword_108.State" };