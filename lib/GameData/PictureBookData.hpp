...
template <> struct Data::Structure<GameData::PictureBookData> : GameData::PictureBookData {
	...
	explicit Structure(Sav& s) : 
		Animal_Bear_A { s.get<struct Animal_Bear_A>() },
		Animal_Bear_B { s.get<struct Animal_Bear_B>() },
		Animal_Boar_A { s.get<struct Animal_Boar_A>() },
		Animal_Boar_B { s.get<struct Animal_Boar_B>() },
		Animal_Bull_A { s.get<struct Animal_Bull_A>() },
		Animal_Cassowary_A { s.get<struct Animal_Cassowary_A>() },
		Animal_Cow_A { s.get<struct Animal_Cow_A>() },
		Animal_Crow_A { s.get<struct Animal_Crow_A>() },
		Animal_Deer_A { s.get<struct Animal_Deer_A>() },
		Animal_Doe_A { s.get<struct Animal_Doe_A>() },
		Animal_Dog_A { s.get<struct Animal_Dog_A>() },
		Animal_Elk_A { s.get<struct Animal_Elk_A>() },
		Animal_Fox_A { s.get<struct Animal_Fox_A>() },
		Animal_Fox_B { s.get<struct Animal_Fox_B>() },
		Animal_Goat_A { s.get<struct Animal_Goat_A>() },
		Animal_Gull_A { s.get<struct Animal_Gull_A>() },
		Animal_Hawk_A { s.get<struct Animal_Hawk_A>() },
		Animal_Heron_A { s.get<struct Animal_Heron_A>() },
		Animal_Heron_B { s.get<struct Animal_Heron_B>() },
		Animal_Insect_A { s.get<struct Animal_Insect_A>() },
		Animal_Insect_AA { s.get<struct Animal_Insect_AA>() },
		Animal_Insect_AB { s.get<struct Animal_Insect_AB>() },
		Animal_Insect_AG { s.get<struct Animal_Insect_AG>() },
		Animal_Insect_AH { s.get<struct Animal_Insect_AH>() },
		Animal_Insect_AI { s.get<struct Animal_Insect_AI>() },
		Animal_Insect_B { s.get<struct Animal_Insect_B>() },
		Animal_Insect_C { s.get<struct Animal_Insect_C>() },
		Animal_Insect_E { s.get<struct Animal_Insect_E>() },
		Animal_Insect_F { s.get<struct Animal_Insect_F>() },
		Animal_Insect_G { s.get<struct Animal_Insect_G>() },
		Animal_Insect_H { s.get<struct Animal_Insect_H>() },
		Animal_Insect_I { s.get<struct Animal_Insect_I>() },
		Animal_Insect_M { s.get<struct Animal_Insect_M>() },
		Animal_Insect_N { s.get<struct Animal_Insect_N>() },
		Animal_Insect_P { s.get<struct Animal_Insect_P>() },
		Animal_Insect_Q { s.get<struct Animal_Insect_Q>() },
		Animal_Insect_R { s.get<struct Animal_Insect_R>() },
		Animal_Insect_S { s.get<struct Animal_Insect_S>() },
		Animal_Insect_T { s.get<struct Animal_Insect_T>() },
		Animal_Insect_X { s.get<struct Animal_Insect_X>() },
		Animal_Kokko_A { s.get<struct Animal_Kokko_A>() },
		Animal_LittleBird_A { s.get<struct Animal_LittleBird_A>() },
		Animal_LittleBird_B { s.get<struct Animal_LittleBird_B>() },
		Animal_LittleBird_C { s.get<struct Animal_LittleBird_C>() },
		Animal_LittleBird_D { s.get<struct Animal_LittleBird_D>() },
		Animal_LittleBird_E { s.get<struct Animal_LittleBird_E>() },
		Animal_LittleBird_F { s.get<struct Animal_LittleBird_F>() },
		Animal_Pao_A { s.get<struct Animal_Pao_A>() },
		Animal_Pigeon_A { s.get<struct Animal_Pigeon_A>() },
		Animal_Pigeon_B { s.get<struct Animal_Pigeon_B>() },
		Animal_Ptarmigan_A { s.get<struct Animal_Ptarmigan_A>() },
		Animal_Ptarmigan_B { s.get<struct Animal_Ptarmigan_B>() },
		Animal_RupeeRabbit_A { s.get<struct Animal_RupeeRabbit_A>() },
		Animal_Sheep_A { s.get<struct Animal_Sheep_A>() },
		Animal_SkyCassowary_A { s.get<struct Animal_SkyCassowary_A>() },
		Animal_SkyGull_A { s.get<struct Animal_SkyGull_A>() },
		Animal_SkyPigeon_A { s.get<struct Animal_SkyPigeon_A>() },
		Animal_Squirrel_A { s.get<struct Animal_Squirrel_A>() },
		Animal_SunazarashiSP_C { s.get<struct Animal_SunazarashiSP_C>() },
		Animal_Sunazarashi_A { s.get<struct Animal_Sunazarashi_A>() },
		Animal_WildDuck_A { s.get<struct Animal_WildDuck_A>() },
		Animal_WildGoat_A { s.get<struct Animal_WildGoat_A>() },
		Animal_Wolf_A { s.get<struct Animal_Wolf_A>() },
		Animal_Wolf_B { s.get<struct Animal_Wolf_B>() },
		Animal_Wolf_C { s.get<struct Animal_Wolf_C>() },
		BeeHome { s.get<struct BeeHome>() },
		BombFruit { s.get<struct BombFruit>() },
		ConfusionFruit { s.get<struct ConfusionFruit>() },
		ElectricalFruit { s.get<struct ElectricalFruit>() },
		Enemy_Assassin_Junior { s.get<struct Enemy_Assassin_Junior>() },
		Enemy_Assassin_Middle { s.get<struct Enemy_Assassin_Middle>() },
		Enemy_Assassin_Senior { s.get<struct Enemy_Assassin_Senior>() },
		Enemy_Bokoblin_Bone_Junior { s.get<struct Enemy_Bokoblin_Bone_Junior>() },
		Enemy_Bokoblin_Boss_Dark { s.get<struct Enemy_Bokoblin_Boss_Dark>() },
		Enemy_Bokoblin_Boss_Junior { s.get<struct Enemy_Bokoblin_Boss_Junior>() },
		Enemy_Bokoblin_Boss_Middle { s.get<struct Enemy_Bokoblin_Boss_Middle>() },
		Enemy_Bokoblin_Boss_Senior { s.get<struct Enemy_Bokoblin_Boss_Senior>() },
		Enemy_Bokoblin_Dark { s.get<struct Enemy_Bokoblin_Dark>() },
		Enemy_Bokoblin_Junior { s.get<struct Enemy_Bokoblin_Junior>() },
		Enemy_Bokoblin_Middle { s.get<struct Enemy_Bokoblin_Middle>() },
		Enemy_Bokoblin_Senior { s.get<struct Enemy_Bokoblin_Senior>() },
		Enemy_CDungeon_Practice { s.get<struct Enemy_CDungeon_Practice>() },
		Enemy_CaveMaster_000 { s.get<struct Enemy_CaveMaster_000>() },
		Enemy_Chuchu_Electric_Junior { s.get<struct Enemy_Chuchu_Electric_Junior>() },
		Enemy_Chuchu_Fire_Junior { s.get<struct Enemy_Chuchu_Fire_Junior>() },
		Enemy_Chuchu_Ice_Junior { s.get<struct Enemy_Chuchu_Ice_Junior>() },
		Enemy_Chuchu_Junior { s.get<struct Enemy_Chuchu_Junior>() },
		Enemy_Dragon_Darkness { s.get<struct Enemy_Dragon_Darkness>() },
		Enemy_Dragon_Electric { s.get<struct Enemy_Dragon_Electric>() },
		Enemy_Dragon_Fire { s.get<struct Enemy_Dragon_Fire>() },
		Enemy_Dragon_Ice { s.get<struct Enemy_Dragon_Ice>() },
		Enemy_Dragon_Light_001 { s.get<struct Enemy_Dragon_Light_001>() },
		Enemy_Drake_Electric { s.get<struct Enemy_Drake_Electric>() },
		Enemy_Drake_Fire { s.get<struct Enemy_Drake_Fire>() },
		Enemy_Drake_Ice { s.get<struct Enemy_Drake_Ice>() },
		Enemy_Drake_Mix { s.get<struct Enemy_Drake_Mix>() },
		Enemy_DungeonBoss_Gerudo { s.get<struct Enemy_DungeonBoss_Gerudo>() },
		Enemy_DungeonBoss_Goron { s.get<struct Enemy_DungeonBoss_Goron>() },
		Enemy_DungeonBoss_Rito { s.get<struct Enemy_DungeonBoss_Rito>() },
		Enemy_DungeonBoss_Zonau { s.get<struct Enemy_DungeonBoss_Zonau>() },
		Enemy_DungeonBoss_Zora { s.get<struct Enemy_DungeonBoss_Zora>() },
		Enemy_Ganondorf { s.get<struct Enemy_Ganondorf>() },
		Enemy_Ganondorf_Miasma { s.get<struct Enemy_Ganondorf_Miasma>() },
		Enemy_Giant_Bone { s.get<struct Enemy_Giant_Bone>() },
		Enemy_Giant_Junior { s.get<struct Enemy_Giant_Junior>() },
		Enemy_Giant_Middle { s.get<struct Enemy_Giant_Middle>() },
		Enemy_Giant_Senior { s.get<struct Enemy_Giant_Senior>() },
		Enemy_Golem_Fire { s.get<struct Enemy_Golem_Fire>() },
		Enemy_Golem_Fort_A { s.get<struct Enemy_Golem_Fort_A>() },
		Enemy_Golem_Ice { s.get<struct Enemy_Golem_Ice>() },
		Enemy_Golem_Junior { s.get<struct Enemy_Golem_Junior>() },
		Enemy_Golem_Little { s.get<struct Enemy_Golem_Little>() },
		Enemy_Golem_Little_Fire { s.get<struct Enemy_Golem_Little_Fire>() },
		Enemy_Golem_Little_Ice { s.get<struct Enemy_Golem_Little_Ice>() },
		Enemy_Golem_Middle { s.get<struct Enemy_Golem_Middle>() },
		Enemy_Golem_Senior { s.get<struct Enemy_Golem_Senior>() },
		Enemy_Horablin_Dark { s.get<struct Enemy_Horablin_Dark>() },
		Enemy_Horablin_Junior { s.get<struct Enemy_Horablin_Junior>() },
		Enemy_Horablin_Middle { s.get<struct Enemy_Horablin_Middle>() },
		Enemy_Horablin_Senior { s.get<struct Enemy_Horablin_Senior>() },
		Enemy_Keese { s.get<struct Enemy_Keese>() },
		Enemy_Keese_Electric { s.get<struct Enemy_Keese_Electric>() },
		Enemy_Keese_Fire { s.get<struct Enemy_Keese_Fire>() },
		Enemy_Keese_Ice { s.get<struct Enemy_Keese_Ice>() },
		Enemy_LikeLike_Crack { s.get<struct Enemy_LikeLike_Crack>() },
		Enemy_LikeLike_Electric { s.get<struct Enemy_LikeLike_Electric>() },
		Enemy_LikeLike_Fire { s.get<struct Enemy_LikeLike_Fire>() },
		Enemy_LikeLike_Ice { s.get<struct Enemy_LikeLike_Ice>() },
		Enemy_LikeLike_Plane { s.get<struct Enemy_LikeLike_Plane>() },
		Enemy_LikeLike_Tar { s.get<struct Enemy_LikeLike_Tar>() },
		Enemy_Lizalfos_Bone_Junior { s.get<struct Enemy_Lizalfos_Bone_Junior>() },
		Enemy_Lizalfos_Dark { s.get<struct Enemy_Lizalfos_Dark>() },
		Enemy_Lizalfos_Electric { s.get<struct Enemy_Lizalfos_Electric>() },
		Enemy_Lizalfos_Fire { s.get<struct Enemy_Lizalfos_Fire>() },
		Enemy_Lizalfos_Ice { s.get<struct Enemy_Lizalfos_Ice>() },
		Enemy_Lizalfos_Junior { s.get<struct Enemy_Lizalfos_Junior>() },
		Enemy_Lizalfos_Middle { s.get<struct Enemy_Lizalfos_Middle>() },
		Enemy_Lizalfos_Senior { s.get<struct Enemy_Lizalfos_Senior>() },
		Enemy_Lynel_Dark { s.get<struct Enemy_Lynel_Dark>() },
		Enemy_Lynel_Junior { s.get<struct Enemy_Lynel_Junior>() },
		Enemy_Lynel_Middle { s.get<struct Enemy_Lynel_Middle>() },
		Enemy_Lynel_Senior { s.get<struct Enemy_Lynel_Senior>() },
		Enemy_MiddleBoss_Goron { s.get<struct Enemy_MiddleBoss_Goron>() },
		Enemy_Mogurudo_Baby_Junior { s.get<struct Enemy_Mogurudo_Baby_Junior>() },
		Enemy_Mogurudo_Junior { s.get<struct Enemy_Mogurudo_Junior>() },
		Enemy_Mogurudo_Middle { s.get<struct Enemy_Mogurudo_Middle>() },
		Enemy_Mogurudo_Senior { s.get<struct Enemy_Mogurudo_Senior>() },
		Enemy_Moriblin_Bone_Junior { s.get<struct Enemy_Moriblin_Bone_Junior>() },
		Enemy_Moriblin_Dark { s.get<struct Enemy_Moriblin_Dark>() },
		Enemy_Moriblin_Junior { s.get<struct Enemy_Moriblin_Junior>() },
		Enemy_Moriblin_Middle { s.get<struct Enemy_Moriblin_Middle>() },
		Enemy_Moriblin_Senior { s.get<struct Enemy_Moriblin_Senior>() },
		Enemy_Octarock { s.get<struct Enemy_Octarock>() },
		Enemy_Octarock_Desert { s.get<struct Enemy_Octarock_Desert>() },
		Enemy_Octarock_Forest { s.get<struct Enemy_Octarock_Forest>() },
		Enemy_Octarock_Snow { s.get<struct Enemy_Octarock_Snow>() },
		Enemy_Octarock_Stone { s.get<struct Enemy_Octarock_Stone>() },
		Enemy_PhantomGanon { s.get<struct Enemy_PhantomGanon>() },
		Enemy_Sandworm { s.get<struct Enemy_Sandworm>() },
		Enemy_Toby_Junior { s.get<struct Enemy_Toby_Junior>() },
		Enemy_Treant_Broadleaf { s.get<struct Enemy_Treant_Broadleaf>() },
		Enemy_Wizzrobe_Electric { s.get<struct Enemy_Wizzrobe_Electric>() },
		Enemy_Wizzrobe_Electric_Senior { s.get<struct Enemy_Wizzrobe_Electric_Senior>() },
		Enemy_Wizzrobe_Fire { s.get<struct Enemy_Wizzrobe_Fire>() },
		Enemy_Wizzrobe_Fire_Senior { s.get<struct Enemy_Wizzrobe_Fire_Senior>() },
		Enemy_Wizzrobe_Ice { s.get<struct Enemy_Wizzrobe_Ice>() },
		Enemy_Wizzrobe_Ice_Senior { s.get<struct Enemy_Wizzrobe_Ice_Senior>() },
		Enemy_Zombie_Boss_Junior { s.get<struct Enemy_Zombie_Boss_Junior>() },
		Enemy_Zombie_Junior { s.get<struct Enemy_Zombie_Junior>() },
		Enemy_Zonau_BlockMaster_Junior { s.get<struct Enemy_Zonau_BlockMaster_Junior>() },
		Enemy_Zonau_BlockMaster_Middle { s.get<struct Enemy_Zonau_BlockMaster_Middle>() },
		Enemy_Zonau_BlockMaster_Senior { s.get<struct Enemy_Zonau_BlockMaster_Senior>() },
		Enemy_Zonau_Golem_Dark { s.get<struct Enemy_Zonau_Golem_Dark>() },
		Enemy_Zonau_Golem_Junior { s.get<struct Enemy_Zonau_Golem_Junior>() },
		Enemy_Zonau_Golem_Middle { s.get<struct Enemy_Zonau_Golem_Middle>() },
		Enemy_Zonau_Golem_Senior { s.get<struct Enemy_Zonau_Golem_Senior>() },
		Enemy_Zonau_Robot_Dark { s.get<struct Enemy_Zonau_Robot_Dark>() },
		Enemy_Zonau_Robot_Junior { s.get<struct Enemy_Zonau_Robot_Junior>() },
		Enemy_Zonau_Robot_Middle { s.get<struct Enemy_Zonau_Robot_Middle>() },
		Enemy_Zonau_Robot_Senior { s.get<struct Enemy_Zonau_Robot_Senior>() },
		FireFruit { s.get<struct FireFruit>() },
		FldObj_HyliaWoodWell_A_02 { s.get<struct FldObj_HyliaWoodWell_A_02>() },
		FldObj_Pinecone_A_01 { s.get<struct FldObj_Pinecone_A_01>() },
		GameRomHorse { s.get<struct GameRomHorse>() },
		GameRomHorse00L { s.get<struct GameRomHorse00L>() },
		GameRomHorse00S { s.get<struct GameRomHorse00S>() },
		GameRomHorse01L { s.get<struct GameRomHorse01L>() },
		GameRomHorseBone { s.get<struct GameRomHorseBone>() },
		GameRomHorseGold { s.get<struct GameRomHorseGold>() },
		GameRomHorseZelda { s.get<struct GameRomHorseZelda>() },
		IceFruit { s.get<struct IceFruit>() },
		Item_Enemy_100 { s.get<struct Item_Enemy_100>() },
		Item_Enemy_101 { s.get<struct Item_Enemy_101>() },
		Item_Enemy_102 { s.get<struct Item_Enemy_102>() },
		Item_Enemy_103 { s.get<struct Item_Enemy_103>() },
		Item_Enemy_106 { s.get<struct Item_Enemy_106>() },
		Item_Enemy_107 { s.get<struct Item_Enemy_107>() },
		Item_Enemy_108 { s.get<struct Item_Enemy_108>() },
		Item_Enemy_109 { s.get<struct Item_Enemy_109>() },
		Item_Enemy_117 { s.get<struct Item_Enemy_117>() },
		Item_Enemy_118 { s.get<struct Item_Enemy_118>() },
		Item_Enemy_119 { s.get<struct Item_Enemy_119>() },
		Item_Enemy_132 { s.get<struct Item_Enemy_132>() },
		Item_Enemy_133 { s.get<struct Item_Enemy_133>() },
		Item_Enemy_134 { s.get<struct Item_Enemy_134>() },
		Item_Enemy_142 { s.get<struct Item_Enemy_142>() },
		Item_Enemy_143 { s.get<struct Item_Enemy_143>() },
		Item_Enemy_144 { s.get<struct Item_Enemy_144>() },
		Item_Enemy_148 { s.get<struct Item_Enemy_148>() },
		Item_Enemy_149 { s.get<struct Item_Enemy_149>() },
		Item_Enemy_15 { s.get<struct Item_Enemy_15>() },
		Item_Enemy_150 { s.get<struct Item_Enemy_150>() },
		Item_Enemy_151 { s.get<struct Item_Enemy_151>() },
		Item_Enemy_153 { s.get<struct Item_Enemy_153>() },
		Item_Enemy_154 { s.get<struct Item_Enemy_154>() },
		Item_Enemy_155 { s.get<struct Item_Enemy_155>() },
		Item_Enemy_16 { s.get<struct Item_Enemy_16>() },
		Item_Enemy_166 { s.get<struct Item_Enemy_166>() },
		Item_Enemy_167 { s.get<struct Item_Enemy_167>() },
		Item_Enemy_168 { s.get<struct Item_Enemy_168>() },
		Item_Enemy_169 { s.get<struct Item_Enemy_169>() },
		Item_Enemy_17 { s.get<struct Item_Enemy_17>() },
		Item_Enemy_181 { s.get<struct Item_Enemy_181>() },
		Item_Enemy_182 { s.get<struct Item_Enemy_182>() },
		Item_Enemy_183 { s.get<struct Item_Enemy_183>() },
		Item_Enemy_184 { s.get<struct Item_Enemy_184>() },
		Item_Enemy_186 { s.get<struct Item_Enemy_186>() },
		Item_Enemy_187 { s.get<struct Item_Enemy_187>() },
		Item_Enemy_188 { s.get<struct Item_Enemy_188>() },
		Item_Enemy_19 { s.get<struct Item_Enemy_19>() },
		Item_Enemy_191 { s.get<struct Item_Enemy_191>() },
		Item_Enemy_192 { s.get<struct Item_Enemy_192>() },
		Item_Enemy_193 { s.get<struct Item_Enemy_193>() },
		Item_Enemy_208 { s.get<struct Item_Enemy_208>() },
		Item_Enemy_210 { s.get<struct Item_Enemy_210>() },
		Item_Enemy_211 { s.get<struct Item_Enemy_211>() },
		Item_Enemy_212 { s.get<struct Item_Enemy_212>() },
		Item_Enemy_213 { s.get<struct Item_Enemy_213>() },
		Item_Enemy_214 { s.get<struct Item_Enemy_214>() },
		Item_Enemy_215 { s.get<struct Item_Enemy_215>() },
		Item_Enemy_216 { s.get<struct Item_Enemy_216>() },
		Item_Enemy_217 { s.get<struct Item_Enemy_217>() },
		Item_Enemy_218 { s.get<struct Item_Enemy_218>() },
		Item_Enemy_228 { s.get<struct Item_Enemy_228>() },
		Item_Enemy_229 { s.get<struct Item_Enemy_229>() },
		Item_Enemy_230 { s.get<struct Item_Enemy_230>() },
		Item_Enemy_231 { s.get<struct Item_Enemy_231>() },
		Item_Enemy_40 { s.get<struct Item_Enemy_40>() },
		Item_Enemy_58 { s.get<struct Item_Enemy_58>() },
		Item_Enemy_59 { s.get<struct Item_Enemy_59>() },
		Item_Enemy_60 { s.get<struct Item_Enemy_60>() },
		Item_Enemy_64 { s.get<struct Item_Enemy_64>() },
		Item_Enemy_66 { s.get<struct Item_Enemy_66>() },
		Item_Enemy_67 { s.get<struct Item_Enemy_67>() },
		Item_Enemy_69 { s.get<struct Item_Enemy_69>() },
		Item_Enemy_77 { s.get<struct Item_Enemy_77>() },
		Item_Enemy_78 { s.get<struct Item_Enemy_78>() },
		Item_Enemy_79 { s.get<struct Item_Enemy_79>() },
		Item_Enemy_80 { s.get<struct Item_Enemy_80>() },
		Item_Enemy_89 { s.get<struct Item_Enemy_89>() },
		Item_Enemy_90 { s.get<struct Item_Enemy_90>() },
		Item_Enemy_91 { s.get<struct Item_Enemy_91>() },
		Item_Enemy_92 { s.get<struct Item_Enemy_92>() },
		Item_FishGet_A { s.get<struct Item_FishGet_A>() },
		Item_FishGet_AA { s.get<struct Item_FishGet_AA>() },
		Item_FishGet_AC { s.get<struct Item_FishGet_AC>() },
		Item_FishGet_B { s.get<struct Item_FishGet_B>() },
		Item_FishGet_C { s.get<struct Item_FishGet_C>() },
		Item_FishGet_D { s.get<struct Item_FishGet_D>() },
		Item_FishGet_E { s.get<struct Item_FishGet_E>() },
		Item_FishGet_F { s.get<struct Item_FishGet_F>() },
		Item_FishGet_G { s.get<struct Item_FishGet_G>() },
		Item_FishGet_H { s.get<struct Item_FishGet_H>() },
		Item_FishGet_I { s.get<struct Item_FishGet_I>() },
		Item_FishGet_J { s.get<struct Item_FishGet_J>() },
		Item_FishGet_L { s.get<struct Item_FishGet_L>() },
		Item_FishGet_M { s.get<struct Item_FishGet_M>() },
		Item_FishGet_X { s.get<struct Item_FishGet_X>() },
		Item_FishGet_Z { s.get<struct Item_FishGet_Z>() },
		Item_Fruit_A { s.get<struct Item_Fruit_A>() },
		Item_Fruit_B { s.get<struct Item_Fruit_B>() },
		Item_Fruit_C { s.get<struct Item_Fruit_C>() },
		Item_Fruit_E { s.get<struct Item_Fruit_E>() },
		Item_Fruit_F { s.get<struct Item_Fruit_F>() },
		Item_Fruit_G { s.get<struct Item_Fruit_G>() },
		Item_Fruit_H { s.get<struct Item_Fruit_H>() },
		Item_Fruit_I { s.get<struct Item_Fruit_I>() },
		Item_Fruit_J { s.get<struct Item_Fruit_J>() },
		Item_Fruit_M { s.get<struct Item_Fruit_M>() },
		Item_Fruit_N { s.get<struct Item_Fruit_N>() },
		Item_Fruit_P { s.get<struct Item_Fruit_P>() },
		Item_InsectGet_K { s.get<struct Item_InsectGet_K>() },
		Item_InsectGet_O { s.get<struct Item_InsectGet_O>() },
		Item_InsectGet_Z { s.get<struct Item_InsectGet_Z>() },
		Item_MushroomGet_D { s.get<struct Item_MushroomGet_D>() },
		Item_MushroomGet_K { s.get<struct Item_MushroomGet_K>() },
		Item_Mushroom_A { s.get<struct Item_Mushroom_A>() },
		Item_Mushroom_B { s.get<struct Item_Mushroom_B>() },
		Item_Mushroom_C { s.get<struct Item_Mushroom_C>() },
		Item_Mushroom_E { s.get<struct Item_Mushroom_E>() },
		Item_Mushroom_F { s.get<struct Item_Mushroom_F>() },
		Item_Mushroom_H { s.get<struct Item_Mushroom_H>() },
		Item_Mushroom_J { s.get<struct Item_Mushroom_J>() },
		Item_Mushroom_L { s.get<struct Item_Mushroom_L>() },
		Item_Mushroom_M { s.get<struct Item_Mushroom_M>() },
		Item_Mushroom_N { s.get<struct Item_Mushroom_N>() },
		Item_Mushroom_O { s.get<struct Item_Mushroom_O>() },
		Item_Mushroom_P { s.get<struct Item_Mushroom_P>() },
		Item_PlantGet_A { s.get<struct Item_PlantGet_A>() },
		Item_PlantGet_B { s.get<struct Item_PlantGet_B>() },
		Item_PlantGet_C { s.get<struct Item_PlantGet_C>() },
		Item_PlantGet_E { s.get<struct Item_PlantGet_E>() },
		Item_PlantGet_F { s.get<struct Item_PlantGet_F>() },
		Item_PlantGet_G { s.get<struct Item_PlantGet_G>() },
		Item_PlantGet_H { s.get<struct Item_PlantGet_H>() },
		Item_PlantGet_I { s.get<struct Item_PlantGet_I>() },
		Item_PlantGet_J { s.get<struct Item_PlantGet_J>() },
		Item_PlantGet_L { s.get<struct Item_PlantGet_L>() },
		Item_PlantGet_M { s.get<struct Item_PlantGet_M>() },
		Item_PlantGet_O { s.get<struct Item_PlantGet_O>() },
		Item_PlantGet_Q { s.get<struct Item_PlantGet_Q>() },
		Item_PlantGet_R { s.get<struct Item_PlantGet_R>() },
		Item_PlantGet_S { s.get<struct Item_PlantGet_S>() },
		Item_PlantGet_U { s.get<struct Item_PlantGet_U>() },
		LightBall_Large { s.get<struct LightBall_Large>() },
		LightBall_Small { s.get<struct LightBall_Small>() },
		LightFruit { s.get<struct LightFruit>() },
		NormalArrow { s.get<struct NormalArrow>() },
		Obj_Mineral_A_01 { s.get<struct Obj_Mineral_A_01>() },
		Obj_Mineral_B_01 { s.get<struct Obj_Mineral_B_01>() },
		Obj_Mineral_C_01 { s.get<struct Obj_Mineral_C_01>() },
		Obj_Mineral_D_01 { s.get<struct Obj_Mineral_D_01>() },
		SmokeFruit { s.get<struct SmokeFruit>() },
		TBox_Field_Iron { s.get<struct TBox_Field_Iron>() },
		WaterFruit { s.get<struct WaterFruit>() },
		Weapon_Bow_001 { s.get<struct Weapon_Bow_001>() },
		Weapon_Bow_002 { s.get<struct Weapon_Bow_002>() },
		Weapon_Bow_003 { s.get<struct Weapon_Bow_003>() },
		Weapon_Bow_004 { s.get<struct Weapon_Bow_004>() },
		Weapon_Bow_006 { s.get<struct Weapon_Bow_006>() },
		Weapon_Bow_009 { s.get<struct Weapon_Bow_009>() },
		Weapon_Bow_011 { s.get<struct Weapon_Bow_011>() },
		Weapon_Bow_013 { s.get<struct Weapon_Bow_013>() },
		Weapon_Bow_014 { s.get<struct Weapon_Bow_014>() },
		Weapon_Bow_015 { s.get<struct Weapon_Bow_015>() },
		Weapon_Bow_016 { s.get<struct Weapon_Bow_016>() },
		Weapon_Bow_017 { s.get<struct Weapon_Bow_017>() },
		Weapon_Bow_026 { s.get<struct Weapon_Bow_026>() },
		Weapon_Bow_027 { s.get<struct Weapon_Bow_027>() },
		Weapon_Bow_028 { s.get<struct Weapon_Bow_028>() },
		Weapon_Bow_029 { s.get<struct Weapon_Bow_029>() },
		Weapon_Bow_030 { s.get<struct Weapon_Bow_030>() },
		Weapon_Bow_032 { s.get<struct Weapon_Bow_032>() },
		Weapon_Bow_033 { s.get<struct Weapon_Bow_033>() },
		Weapon_Bow_035 { s.get<struct Weapon_Bow_035>() },
		Weapon_Bow_036 { s.get<struct Weapon_Bow_036>() },
		Weapon_Bow_038 { s.get<struct Weapon_Bow_038>() },
		Weapon_Bow_040 { s.get<struct Weapon_Bow_040>() },
		Weapon_Bow_072 { s.get<struct Weapon_Bow_072>() },
		Weapon_Bow_101 { s.get<struct Weapon_Bow_101>() },
		Weapon_Bow_104 { s.get<struct Weapon_Bow_104>() },
		Weapon_Bow_105 { s.get<struct Weapon_Bow_105>() },
		Weapon_Bow_106 { s.get<struct Weapon_Bow_106>() },
		Weapon_Bow_107 { s.get<struct Weapon_Bow_107>() },
		Weapon_Bow_166 { s.get<struct Weapon_Bow_166>() },
		Weapon_Lsword_001 { s.get<struct Weapon_Lsword_001>() },
		Weapon_Lsword_002 { s.get<struct Weapon_Lsword_002>() },
		Weapon_Lsword_003 { s.get<struct Weapon_Lsword_003>() },
		Weapon_Lsword_019 { s.get<struct Weapon_Lsword_019>() },
		Weapon_Lsword_020 { s.get<struct Weapon_Lsword_020>() },
		Weapon_Lsword_024 { s.get<struct Weapon_Lsword_024>() },
		Weapon_Lsword_027 { s.get<struct Weapon_Lsword_027>() },
		Weapon_Lsword_029 { s.get<struct Weapon_Lsword_029>() },
		Weapon_Lsword_036 { s.get<struct Weapon_Lsword_036>() },
		Weapon_Lsword_038 { s.get<struct Weapon_Lsword_038>() },
		Weapon_Lsword_041 { s.get<struct Weapon_Lsword_041>() },
		Weapon_Lsword_045 { s.get<struct Weapon_Lsword_045>() },
		Weapon_Lsword_047 { s.get<struct Weapon_Lsword_047>() },
		Weapon_Lsword_051 { s.get<struct Weapon_Lsword_051>() },
		Weapon_Lsword_054 { s.get<struct Weapon_Lsword_054>() },
		Weapon_Lsword_057 { s.get<struct Weapon_Lsword_057>() },
		Weapon_Lsword_059 { s.get<struct Weapon_Lsword_059>() },
		Weapon_Lsword_060 { s.get<struct Weapon_Lsword_060>() },
		Weapon_Lsword_101 { s.get<struct Weapon_Lsword_101>() },
		Weapon_Lsword_103 { s.get<struct Weapon_Lsword_103>() },
		Weapon_Lsword_106 { s.get<struct Weapon_Lsword_106>() },
		Weapon_Lsword_108 { s.get<struct Weapon_Lsword_108>() },
		Weapon_Lsword_109 { s.get<struct Weapon_Lsword_109>() },
		Weapon_Lsword_112 { s.get<struct Weapon_Lsword_112>() },
		Weapon_Lsword_113 { s.get<struct Weapon_Lsword_113>() },
		Weapon_Lsword_114 { s.get<struct Weapon_Lsword_114>() },
		Weapon_Lsword_124 { s.get<struct Weapon_Lsword_124>() },
		Weapon_Lsword_127 { s.get<struct Weapon_Lsword_127>() },
		Weapon_Lsword_129 { s.get<struct Weapon_Lsword_129>() },
		Weapon_Lsword_136 { s.get<struct Weapon_Lsword_136>() },
		Weapon_Lsword_147 { s.get<struct Weapon_Lsword_147>() },
		Weapon_Lsword_161 { s.get<struct Weapon_Lsword_161>() },
		Weapon_Lsword_163 { s.get<struct Weapon_Lsword_163>() },
		Weapon_Lsword_164 { s.get<struct Weapon_Lsword_164>() },
		Weapon_Lsword_166 { s.get<struct Weapon_Lsword_166>() },
		Weapon_Lsword_174 { s.get<struct Weapon_Lsword_174>() },
		Weapon_Shield_001 { s.get<struct Weapon_Shield_001>() },
		Weapon_Shield_002 { s.get<struct Weapon_Shield_002>() },
		Weapon_Shield_003 { s.get<struct Weapon_Shield_003>() },
		Weapon_Shield_004 { s.get<struct Weapon_Shield_004>() },
		Weapon_Shield_005 { s.get<struct Weapon_Shield_005>() },
		Weapon_Shield_006 { s.get<struct Weapon_Shield_006>() },
		Weapon_Shield_007 { s.get<struct Weapon_Shield_007>() },
		Weapon_Shield_008 { s.get<struct Weapon_Shield_008>() },
		Weapon_Shield_009 { s.get<struct Weapon_Shield_009>() },
		Weapon_Shield_016 { s.get<struct Weapon_Shield_016>() },
		Weapon_Shield_017 { s.get<struct Weapon_Shield_017>() },
		Weapon_Shield_018 { s.get<struct Weapon_Shield_018>() },
		Weapon_Shield_021 { s.get<struct Weapon_Shield_021>() },
		Weapon_Shield_022 { s.get<struct Weapon_Shield_022>() },
		Weapon_Shield_023 { s.get<struct Weapon_Shield_023>() },
		Weapon_Shield_025 { s.get<struct Weapon_Shield_025>() },
		Weapon_Shield_026 { s.get<struct Weapon_Shield_026>() },
		Weapon_Shield_030 { s.get<struct Weapon_Shield_030>() },
		Weapon_Shield_031 { s.get<struct Weapon_Shield_031>() },
		Weapon_Shield_032 { s.get<struct Weapon_Shield_032>() },
		Weapon_Shield_033 { s.get<struct Weapon_Shield_033>() },
		Weapon_Shield_034 { s.get<struct Weapon_Shield_034>() },
		Weapon_Shield_035 { s.get<struct Weapon_Shield_035>() },
		Weapon_Shield_036 { s.get<struct Weapon_Shield_036>() },
		Weapon_Shield_037 { s.get<struct Weapon_Shield_037>() },
		Weapon_Shield_040 { s.get<struct Weapon_Shield_040>() },
		Weapon_Shield_041 { s.get<struct Weapon_Shield_041>() },
		Weapon_Shield_042 { s.get<struct Weapon_Shield_042>() },
		Weapon_Shield_057 { s.get<struct Weapon_Shield_057>() },
		Weapon_Shield_101 { s.get<struct Weapon_Shield_101>() },
		Weapon_Shield_102 { s.get<struct Weapon_Shield_102>() },
		Weapon_Shield_103 { s.get<struct Weapon_Shield_103>() },
		Weapon_Shield_107 { s.get<struct Weapon_Shield_107>() },
		Weapon_Spear_001 { s.get<struct Weapon_Spear_001>() },
		Weapon_Spear_002 { s.get<struct Weapon_Spear_002>() },
		Weapon_Spear_003 { s.get<struct Weapon_Spear_003>() },
		Weapon_Spear_021 { s.get<struct Weapon_Spear_021>() },
		Weapon_Spear_022 { s.get<struct Weapon_Spear_022>() },
		Weapon_Spear_024 { s.get<struct Weapon_Spear_024>() },
		Weapon_Spear_025 { s.get<struct Weapon_Spear_025>() },
		Weapon_Spear_027 { s.get<struct Weapon_Spear_027>() },
		Weapon_Spear_029 { s.get<struct Weapon_Spear_029>() },
		Weapon_Spear_030 { s.get<struct Weapon_Spear_030>() },
		Weapon_Spear_032 { s.get<struct Weapon_Spear_032>() },
		Weapon_Spear_036 { s.get<struct Weapon_Spear_036>() },
		Weapon_Spear_038 { s.get<struct Weapon_Spear_038>() },
		Weapon_Spear_047 { s.get<struct Weapon_Spear_047>() },
		Weapon_Spear_050 { s.get<struct Weapon_Spear_050>() },
		Weapon_Spear_101 { s.get<struct Weapon_Spear_101>() },
		Weapon_Spear_103 { s.get<struct Weapon_Spear_103>() },
		Weapon_Spear_106 { s.get<struct Weapon_Spear_106>() },
		Weapon_Spear_108 { s.get<struct Weapon_Spear_108>() },
		Weapon_Spear_109 { s.get<struct Weapon_Spear_109>() },
		Weapon_Spear_112 { s.get<struct Weapon_Spear_112>() },
		Weapon_Spear_113 { s.get<struct Weapon_Spear_113>() },
		Weapon_Spear_124 { s.get<struct Weapon_Spear_124>() },
		Weapon_Spear_125 { s.get<struct Weapon_Spear_125>() },
		Weapon_Spear_127 { s.get<struct Weapon_Spear_127>() },
		Weapon_Spear_129 { s.get<struct Weapon_Spear_129>() },
		Weapon_Spear_132 { s.get<struct Weapon_Spear_132>() },
		Weapon_Spear_147 { s.get<struct Weapon_Spear_147>() },
		Weapon_Spear_161 { s.get<struct Weapon_Spear_161>() },
		Weapon_Spear_163 { s.get<struct Weapon_Spear_163>() },
		Weapon_Spear_164 { s.get<struct Weapon_Spear_164>() },
		Weapon_Spear_166 { s.get<struct Weapon_Spear_166>() },
		Weapon_Spear_173 { s.get<struct Weapon_Spear_173>() },
		Weapon_Sword_001 { s.get<struct Weapon_Sword_001>() },
		Weapon_Sword_002 { s.get<struct Weapon_Sword_002>() },
		Weapon_Sword_003 { s.get<struct Weapon_Sword_003>() },
		Weapon_Sword_019 { s.get<struct Weapon_Sword_019>() },
		Weapon_Sword_020 { s.get<struct Weapon_Sword_020>() },
		Weapon_Sword_021 { s.get<struct Weapon_Sword_021>() },
		Weapon_Sword_022 { s.get<struct Weapon_Sword_022>() },
		Weapon_Sword_024 { s.get<struct Weapon_Sword_024>() },
		Weapon_Sword_025 { s.get<struct Weapon_Sword_025>() },
		Weapon_Sword_027 { s.get<struct Weapon_Sword_027>() },
		Weapon_Sword_029 { s.get<struct Weapon_Sword_029>() },
		Weapon_Sword_031 { s.get<struct Weapon_Sword_031>() },
		Weapon_Sword_041 { s.get<struct Weapon_Sword_041>() },
		Weapon_Sword_043 { s.get<struct Weapon_Sword_043>() },
		Weapon_Sword_044 { s.get<struct Weapon_Sword_044>() },
		Weapon_Sword_047 { s.get<struct Weapon_Sword_047>() },
		Weapon_Sword_051 { s.get<struct Weapon_Sword_051>() },
		Weapon_Sword_052 { s.get<struct Weapon_Sword_052>() },
		Weapon_Sword_057 { s.get<struct Weapon_Sword_057>() },
		Weapon_Sword_058 { s.get<struct Weapon_Sword_058>() },
		Weapon_Sword_059 { s.get<struct Weapon_Sword_059>() },
		Weapon_Sword_070 { s.get<struct Weapon_Sword_070>() },
		Weapon_Sword_101 { s.get<struct Weapon_Sword_101>() },
		Weapon_Sword_103 { s.get<struct Weapon_Sword_103>() },
		Weapon_Sword_105 { s.get<struct Weapon_Sword_105>() },
		Weapon_Sword_106 { s.get<struct Weapon_Sword_106>() },
		Weapon_Sword_107 { s.get<struct Weapon_Sword_107>() },
		Weapon_Sword_108 { s.get<struct Weapon_Sword_108>() },
		Weapon_Sword_109 { s.get<struct Weapon_Sword_109>() },
		Weapon_Sword_112 { s.get<struct Weapon_Sword_112>() },
		Weapon_Sword_113 { s.get<struct Weapon_Sword_113>() },
		Weapon_Sword_114 { s.get<struct Weapon_Sword_114>() },
		Weapon_Sword_124 { s.get<struct Weapon_Sword_124>() },
		Weapon_Sword_125 { s.get<struct Weapon_Sword_125>() },
		Weapon_Sword_127 { s.get<struct Weapon_Sword_127>() },
		Weapon_Sword_129 { s.get<struct Weapon_Sword_129>() },
		Weapon_Sword_131 { s.get<struct Weapon_Sword_131>() },
		Weapon_Sword_147 { s.get<struct Weapon_Sword_147>() },
		Weapon_Sword_161 { s.get<struct Weapon_Sword_161>() },
		Weapon_Sword_163 { s.get<struct Weapon_Sword_163>() },
		Weapon_Sword_164 { s.get<struct Weapon_Sword_164>() },
		Weapon_Sword_166 { s.get<struct Weapon_Sword_166>() }
	{ }
};/* Structure Data::Structure GameData::PictureBookData close */
