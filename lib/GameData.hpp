...
template <> hash_value_t constexpr Data::Hashtable<GameData::WellCollectionRewardUnit> { "WellCollectionRewardUnit" };
template <> hash_value_t constexpr Data::Hashtable<GameData::WellDiscoverNumCurrent> { "WellDiscoverNumCurrent" };
template <> hash_value_t constexpr Data::Hashtable<GameData::WellDiscoverNumLeft> { "WellDiscoverNumLeft" };
template <> hash_value_t constexpr Data::Hashtable<GameData::WellDiscoverNumTotal> { "WellDiscoverNumTotal" };
template <> hash_value_t constexpr Data::Hashtable<GameData::WellReportNum> { "WellReportNum" };
template <> hash_value_t constexpr Data::Hashtable<GameData::WellReportNumMinusOne> { "WellReportNumMinusOne" };
template <> hash_value_t constexpr Data::Hashtable<GameData::WellReportNumThisTime> { "WellReportNumThisTime" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_BloodyMoonTimer> { "World_BloodyMoonTimer" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_CurrentDateTime> { "World_CurrentDateTime" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_CurrentDays> { "World_CurrentDays" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_CurrentHour> { "World_CurrentHour" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_CurrentMinute> { "World_CurrentMinute" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_IsBloodyMoonDay> { "World_IsBloodyMoonDay" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_IsZonauRespawnDay> { "World_IsZonauRespawnDay" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_PlayerPos> { "World_PlayerPos" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_ShootingStarPosition> { "World_ShootingStarPosition" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_WeatherForecast> { "World_WeatherForecast" };
template <> hash_value_t constexpr Data::Hashtable<GameData::World_ZonauRespawnTimer> { "World_ZonauRespawnTimer" };
...
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_AisyaRescue> { "Step_AisyaRescue" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_AmberCollector> { "Step_AmberCollector" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ArrowMeister_Momo> { "Step_ArrowMeister_Momo" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_AssassinGerudoBase> { "Step_AssassinGerudoBase" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BallBring_MiniGame> { "Step_BallBring_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Basketball_MiniGame> { "Step_Basketball_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Big_Rotate> { "Step_Big_Rotate" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BirdManContest> { "Step_BirdManContest" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BlindRuinsTreasure> { "Step_BlindRuinsTreasure" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BlindRuinsTreasure_Gerudo> { "Step_BlindRuinsTreasure_Gerudo" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BlindRuinsTreasure_Goron> { "Step_BlindRuinsTreasure_Goron" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BlindRuinsTreasure_Rito> { "Step_BlindRuinsTreasure_Rito" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BlindRuinsTreasure_Zora> { "Step_BlindRuinsTreasure_Zora" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BuildHouse> { "Step_BuildHouse" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_BuildingMaterialsTutorial> { "Step_BuildingMaterialsTutorial" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CDungeon_AllDone> { "Step_CDungeon_AllDone" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryGoronKid1> { "Step_CarryGoronKid1" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryGoronKid2> { "Step_CarryGoronKid2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryStone> { "Step_CarryStone" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine01> { "Step_CarryToShrine01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine02> { "Step_CarryToShrine02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine03> { "Step_CarryToShrine03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine05> { "Step_CarryToShrine05" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine06> { "Step_CarryToShrine06" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine07> { "Step_CarryToShrine07" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine08_Zora> { "Step_CarryToShrine08_Zora" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine09> { "Step_CarryToShrine09" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine10> { "Step_CarryToShrine10" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine11> { "Step_CarryToShrine11" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine12> { "Step_CarryToShrine12" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine13> { "Step_CarryToShrine13" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine14> { "Step_CarryToShrine14" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine15> { "Step_CarryToShrine15" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine16> { "Step_CarryToShrine16" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine17> { "Step_CarryToShrine17" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine19> { "Step_CarryToShrine19" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine20> { "Step_CarryToShrine20" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine21> { "Step_CarryToShrine21" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine22> { "Step_CarryToShrine22" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CarryToShrine23> { "Step_CarryToShrine23" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Circuit_Desert> { "Step_Circuit_Desert" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Circuit_FaronWoods_MiniGame> { "Step_Circuit_FaronWoods_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Circuit_Ichikara> { "Step_Circuit_Ichikara" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Circuit_Ichikara_MiniGame> { "Step_Circuit_Ichikara_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Circuit_Uotori_MiniGame> { "Step_Circuit_Uotori_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CleanStatue> { "Step_CleanStatue" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ClueTotheSixthSage> { "Step_ClueTotheSixthSage" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CollectObject_MiniGame> { "Step_CollectObject_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CollectObject_MiniGame_Cliff> { "Step_CollectObject_MiniGame_Cliff" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CollectObject_MiniGame_LakeSide> { "Step_CollectObject_MiniGame_LakeSide" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Connect_AkkareMaze> { "Step_Connect_AkkareMaze" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Connect_FirstIsland> { "Step_Connect_FirstIsland" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Connect_GerudoMaze> { "Step_Connect_GerudoMaze" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Connect_TabantaMaze> { "Step_Connect_TabantaMaze" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CookAtBaseCamp> { "Step_CookAtBaseCamp" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CraftShadowPicture> { "Step_CraftShadowPicture" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_CreateArmor> { "Step_CreateArmor" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Createshinguard> { "Step_Createshinguard" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DeepHoleSurvey2> { "Step_DeepHoleSurvey2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatGanondorf> { "Step_DefeatGanondorf" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatHugeEnemy_1> { "Step_DefeatHugeEnemy_1" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatHugeEnemy_2> { "Step_DefeatHugeEnemy_2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatHugeEnemy_3> { "Step_DefeatHugeEnemy_3" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatHugeEnemy_4> { "Step_DefeatHugeEnemy_4" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatHugeEnemy_5> { "Step_DefeatHugeEnemy_5" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DefeatHugeEnemy_6> { "Step_DefeatHugeEnemy_6" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DevoteSpring> { "Step_DevoteSpring" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_DividedSlate> { "Step_DividedSlate" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_EightHeroStatues> { "Step_EightHeroStatues" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_EightHeroStatues_After> { "Step_EightHeroStatues_After" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_EveryonesMeal> { "Step_EveryonesMeal" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ExcavateFossil1> { "Step_ExcavateFossil1" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ExcavateFossil2> { "Step_ExcavateFossil2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ExcavateFossil3> { "Step_ExcavateFossil3" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Fairy2> { "Step_Fairy2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Fairy3> { "Step_Fairy3" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Fairy4> { "Step_Fairy4" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FindDrefan> { "Step_FindDrefan" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FindSunaNui> { "Step_FindSunaNui" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FindSunaNui2> { "Step_FindSunaNui2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FindWhiteHorse> { "Step_FindWhiteHorse" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FindWithSensors> { "Step_FindWithSensors" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FirstskyislandReturns> { "Step_FirstskyislandReturns" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_FullyRipenedFlintstones> { "Step_FullyRipenedFlintstones" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GOToTheCastleOfHyrule> { "Step_GOToTheCastleOfHyrule" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GeniusWeapon_Zora> { "Step_GeniusWeapon_Zora" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Genkos_Kitchen> { "Step_Genkos_Kitchen" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GerudoCanyon_24hEnduranceComparison> { "Step_GerudoCanyon_24hEnduranceComparison" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GerudoCanyon_Adventure> { "Step_GerudoCanyon_Adventure" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GerudoCanyon_ColdEnduranceComparison> { "Step_GerudoCanyon_ColdEnduranceComparison" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GerudoCanyon_GleeokLiver> { "Step_GerudoCanyon_GleeokLiver" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GerudoCanyon_TumbleweedSweep> { "Step_GerudoCanyon_TumbleweedSweep" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GerudoDesertTreasure> { "Step_GerudoDesertTreasure" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Gerudo_UrbosaWeapon> { "Step_Gerudo_UrbosaWeapon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GetCamera> { "Step_GetCamera" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GetMasterSword> { "Step_GetMasterSword" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GetSensorPlus> { "Step_GetSensorPlus" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GetWalker> { "Step_GetWalker" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GetWarpMarker> { "Step_GetWarpMarker" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GiantHorse> { "Step_GiantHorse" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GoneSnowQueen> { "Step_GoneSnowQueen" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GoronPond> { "Step_GoronPond" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GoronReturntoNature> { "Step_GoronReturntoNature" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Goron_MiniGame_01> { "Step_Goron_MiniGame_01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Goron_MiniGame_02> { "Step_Goron_MiniGame_02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Goron_MiniGame_03> { "Step_Goron_MiniGame_03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Goron_MiniGame_Tutorial_01> { "Step_Goron_MiniGame_Tutorial_01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Goron_MiniGame_Tutorial_02> { "Step_Goron_MiniGame_Tutorial_02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Goron_MiniGame_Tutorial_03> { "Step_Goron_MiniGame_Tutorial_03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GotoFironeZonauRemains> { "Step_GotoFironeZonauRemains" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_GroundPaintingAir01> { "Step_GroundPaintingAir01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hack_GuardGoods> { "Step_Hack_GuardGoods" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HammerGong_MiniGame> { "Step_HammerGong_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HatenoPurchasePicture> { "Step_HatenoPurchasePicture" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_Cheese> { "Step_Hateno_Cheese" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_CoolGuy> { "Step_Hateno_CoolGuy" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_FreshMilk> { "Step_Hateno_FreshMilk" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_LetUsElection> { "Step_Hateno_LetUsElection" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_NewCostume> { "Step_Hateno_NewCostume" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_NewSpecialty> { "Step_Hateno_NewSpecialty" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_RevitalizeByNewSpeciality> { "Step_Hateno_RevitalizeByNewSpeciality" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_SecretLifeOfKusayoshi> { "Step_Hateno_SecretLifeOfKusayoshi" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_SecretLifeOfSagono> { "Step_Hateno_SecretLifeOfSagono" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_TellMeTeacher01> { "Step_Hateno_TellMeTeacher01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_TellMeTeacher02> { "Step_Hateno_TellMeTeacher02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_VillageMayorElection> { "Step_Hateno_VillageMayorElection" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hateno_WhatToPlant> { "Step_Hateno_WhatToPlant" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hebra_SkyRingChallenge> { "Step_Hebra_SkyRingChallenge" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Hebra_SkyRingChallenge_MiniGame> { "Step_Hebra_SkyRingChallenge_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HorseInnChallenge001> { "Step_HorseInnChallenge001" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HorseInnChallenge002> { "Step_HorseInnChallenge002" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HorseInnChallenge003> { "Step_HorseInnChallenge003" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HorseInnChallenge005> { "Step_HorseInnChallenge005" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HorseInnChallenge007> { "Step_HorseInnChallenge007" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HotSpringEgg> { "Step_HotSpringEgg" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HourseInnChallenge004> { "Step_HourseInnChallenge004" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HuntSalmon> { "Step_HuntSalmon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_HyruleCastleIncident> { "Step_HyruleCastleIncident" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_IceMaking> { "Step_IceMaking" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_IchikaraChallenge01> { "Step_IchikaraChallenge01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_IchikaraChallenge03> { "Step_IchikaraChallenge03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_IchikaraCircuit_Tutorial> { "Step_IchikaraCircuit_Tutorial" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_IchikaraDaughterPhoto> { "Step_IchikaraDaughterPhoto" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_IllnessStartsWithFeelings> { "Step_IllnessStartsWithFeelings" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_InfiltrationFromTheSky> { "Step_InfiltrationFromTheSky" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_InnNeverReturns> { "Step_InnNeverReturns" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_JobSunazarashi> { "Step_JobSunazarashi" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Know_FourStonePlates> { "Step_Know_FourStonePlates" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_KokkoGuidePost> { "Step_KokkoGuidePost" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Korok_CarryToShrine> { "Step_Korok_CarryToShrine" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Lodge_Chemical001> { "Step_Lodge_Chemical001" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_LookingForLightSpot> { "Step_LookingForLightSpot" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_LookingForTheVoiceLord> { "Step_LookingForTheVoiceLord" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mack_SecretBase> { "Step_Mack_SecretBase" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MainChallenge> { "Step_MainChallenge" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MakeAChampionsWeapon_Goron> { "Step_MakeAChampionsWeapon_Goron" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MakeChemicalWeapon> { "Step_MakeChemicalWeapon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MasterSwordClues> { "Step_MasterSwordClues" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MeatRock> { "Step_MeatRock" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MemoryOfTheDragon> { "Step_MemoryOfTheDragon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MercenaryChallenge_Akkare> { "Step_MercenaryChallenge_Akkare" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MercenaryChallenge_Eldin> { "Step_MercenaryChallenge_Eldin" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MercenaryChallenge_Firone> { "Step_MercenaryChallenge_Firone" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MercenaryChallenge_Hateru> { "Step_MercenaryChallenge_Hateru" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MercenaryChallenge_Hebra> { "Step_MercenaryChallenge_Hebra" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MercenaryChallenge_HyrulePlain> { "Step_MercenaryChallenge_HyrulePlain" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mercenary_Akkare_Bloody> { "Step_Mercenary_Akkare_Bloody" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mercenary_Eldin_Bloody> { "Step_Mercenary_Eldin_Bloody" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mercenary_Firone_Bloody> { "Step_Mercenary_Firone_Bloody" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mercenary_Hateru_Bloody> { "Step_Mercenary_Hateru_Bloody" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mercenary_Hebra_Bloody> { "Step_Mercenary_Hebra_Bloody" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Mercenary_HyrulePlain_Bloody> { "Step_Mercenary_HyrulePlain_Bloody" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MessageBottle_SOS> { "Step_MessageBottle_SOS" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MinusYiga> { "Step_MinusYiga" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MonsterFigures01> { "Step_MonsterFigures01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MonsterFigures02> { "Step_MonsterFigures02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MonsterFigures03> { "Step_MonsterFigures03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MonsterFigures04> { "Step_MonsterFigures04" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MonsterFigures05> { "Step_MonsterFigures05" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MushroomSisters_1> { "Step_MushroomSisters_1" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MushroomSisters_2> { "Step_MushroomSisters_2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_MushroomSisters_3> { "Step_MushroomSisters_3" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Nazley_DigCave> { "Step_Nazley_DigCave" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Neck_IceWaterCave> { "Step_Neck_IceWaterCave" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_NewCanyonMissingPersonsCase> { "Step_NewCanyonMissingPersonsCase" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_NewsPaper_Mitsuba> { "Step_NewsPaper_Mitsuba" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_NoTrespassing> { "Step_NoTrespassing" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_NowInTheVillageOfLurelin> { "Step_NowInTheVillageOfLurelin" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Npc_BaseCamp_Assistant_ReactingStatue> { "Step_Npc_BaseCamp_Assistant_ReactingStatue" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Npc_BaseCamp_Assistant_ReactingStatue2> { "Step_Npc_BaseCamp_Assistant_ReactingStatue2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Npc_BaseCamp_Assistant_ReactingStatue3> { "Step_Npc_BaseCamp_Assistant_ReactingStatue3" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Npc_BaseCamp_Assistant_ReactingStatue4> { "Step_Npc_BaseCamp_Assistant_ReactingStatue4" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_NushiShop_Challenge00> { "Step_NushiShop_Challenge00" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_NushiShop_Tutorial> { "Step_NushiShop_Tutorial" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_OldKorokHelp> { "Step_OldKorokHelp" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Orchestra01> { "Step_Orchestra01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Orchestra02> { "Step_Orchestra02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Orchestra03> { "Step_Orchestra03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Orchestra04> { "Step_Orchestra04" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Our_Treasure> { "Step_Our_Treasure" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Parasail_ChuchuDesign> { "Step_Parasail_ChuchuDesign" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_01> { "Step_PhotoSpot_Challenge_01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_02> { "Step_PhotoSpot_Challenge_02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_03> { "Step_PhotoSpot_Challenge_03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_04> { "Step_PhotoSpot_Challenge_04" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_05> { "Step_PhotoSpot_Challenge_05" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_06> { "Step_PhotoSpot_Challenge_06" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_07> { "Step_PhotoSpot_Challenge_07" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_08> { "Step_PhotoSpot_Challenge_08" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_09> { "Step_PhotoSpot_Challenge_09" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_09_2> { "Step_PhotoSpot_Challenge_09_2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_10> { "Step_PhotoSpot_Challenge_10" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_11> { "Step_PhotoSpot_Challenge_11" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_12> { "Step_PhotoSpot_Challenge_12" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_13> { "Step_PhotoSpot_Challenge_13" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_PhotoSpot_Challenge_14> { "Step_PhotoSpot_Challenge_14" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Raise_GoddesStatue> { "Step_Raise_GoddesStatue" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Raise_GoddesStatue_Courage> { "Step_Raise_GoddesStatue_Courage" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Raise_GoddesStatue_Power> { "Step_Raise_GoddesStatue_Power" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Raise_GoddesStatue_Wisdom> { "Step_Raise_GoddesStatue_Wisdom" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_RepairArmor> { "Step_RepairArmor" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_RescueHost> { "Step_RescueHost" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_RescueVehicle01> { "Step_RescueVehicle01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_RescueWell> { "Step_RescueWell" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ResearchEldin> { "Step_ResearchEldin" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ResearchLanayru> { "Step_ResearchLanayru" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_RestaurantInTheWell> { "Step_RestaurantInTheWell" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_RitoBridgeRepair> { "Step_RitoBridgeRepair" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Rito_ItemExchange> { "Step_Rito_ItemExchange" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Rito_MedoArmor> { "Step_Rito_MedoArmor" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Rito_RevaliWeapon> { "Step_Rito_RevaliWeapon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Rito_ShadowCave> { "Step_Rito_ShadowCave" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SageOfFire> { "Step_SageOfFire" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SageOfGerudo> { "Step_SageOfGerudo" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SageOfSky> { "Step_SageOfSky" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SageOfSoul> { "Step_SageOfSoul" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SageOfWind> { "Step_SageOfWind" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SageOfZora> { "Step_SageOfZora" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SaihateSubjugation> { "Step_SaihateSubjugation" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SearchCaravan> { "Step_SearchCaravan" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SecretBase_MiniGame> { "Step_SecretBase_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ShieldSurfing_MiniGame> { "Step_ShieldSurfing_MiniGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SkyIsland_MiniGame_01> { "Step_SkyIsland_MiniGame_01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SkyIsland_MiniGame_02> { "Step_SkyIsland_MiniGame_02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SkyIsland_MiniGame_03> { "Step_SkyIsland_MiniGame_03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SnowyMountain_Surfing> { "Step_SnowyMountain_Surfing" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_StatueDevilTutorial> { "Step_StatueDevilTutorial" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_SurveyOfFourVillages> { "Step_SurveyOfFourVillages" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TakeAnimals> { "Step_TakeAnimals" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TakeOfIce> { "Step_TakeOfIce" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TauraChallenge001> { "Step_TauraChallenge001" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TheStrongestWeapon> { "Step_TheStrongestWeapon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureHunt_kokiri> { "Step_TreasureHunt_kokiri" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLambda> { "Step_TreasureOfLambda" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_Dream> { "Step_TreasureOfLamda_Dream" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_Dream2> { "Step_TreasureOfLamda_Dream2" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_Dream3> { "Step_TreasureOfLamda_Dream3" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_DuelPeak> { "Step_TreasureOfLamda_DuelPeak" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_FierceDeity> { "Step_TreasureOfLamda_FierceDeity" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_Gerudo> { "Step_TreasureOfLamda_Gerudo" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_TreasureOfLamda_Pirate> { "Step_TreasureOfLamda_Pirate" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune01> { "Step_Tribune01" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune02> { "Step_Tribune02" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune03> { "Step_Tribune03" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune04> { "Step_Tribune04" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune05> { "Step_Tribune05" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune06> { "Step_Tribune06" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune07> { "Step_Tribune07" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune09> { "Step_Tribune09" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune10> { "Step_Tribune10" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune11> { "Step_Tribune11" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune13> { "Step_Tribune13" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune14> { "Step_Tribune14" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Tribune16> { "Step_Tribune16" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Uotori_BreakthePirateBase> { "Step_Uotori_BreakthePirateBase" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Uotori_Designer> { "Step_Uotori_Designer" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Uotori_ResortPlan> { "Step_Uotori_ResortPlan" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Uotori_RevivePlan> { "Step_Uotori_RevivePlan" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Uotori_WhiteLineGame> { "Step_Uotori_WhiteLineGame" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_UpgradeOfPurahPad1> { "Step_UpgradeOfPurahPad1" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_WantedCleaning> { "Step_WantedCleaning" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_WashedAwayBusinessTools> { "Step_WashedAwayBusinessTools" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_WaterBridgePlace> { "Step_WaterBridgePlace" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_WellCollection> { "Step_WellCollection" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_WhichIsStronger> { "Step_WhichIsStronger" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ZonauReliefSearch> { "Step_ZonauReliefSearch" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Zonau_GeniusWeapon> { "Step_Zonau_GeniusWeapon" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_ZoraStatue_Picture> { "Step_ZoraStatue_Picture" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Zora_Enemy_hunt> { "Step_Zora_Enemy_hunt" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Zora_MessageBottle> { "Step_Zora_MessageBottle" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_Zora_RuttaTreasure> { "Step_Zora_RuttaTreasure" };
template <> hash_value_t constexpr Data::Hashtable<GameData::Step_gather_Insect_Z> { "Step_gather_Insect_Z" };