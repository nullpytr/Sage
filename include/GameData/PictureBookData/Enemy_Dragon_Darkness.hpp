...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Dragon_Darkness> : GameData::PictureBookData::Enemy_Dragon_Darkness {
	...
	{ }
};/* Data::Structure GameData::PictureBookData::Enemy_Dragon_Darkness close */

template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Dragon_Darkness::State> = murmurhash3::hash("PictureBookData.Enemy_Dragon_Darkness.State");