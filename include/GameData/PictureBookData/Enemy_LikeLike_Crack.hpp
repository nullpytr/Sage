...
template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_LikeLike_Crack::State> = murmurhash3::hash("PictureBookData.Enemy_LikeLike_Crack.State");