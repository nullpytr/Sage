...
template <> struct Data::Structure<GameData::PictureBookData::Weapon_Spear_132> : GameData::PictureBookData::Weapon_Spear_132 {
	...
	{ }
};/* Data::Structure GameData::PictureBookData::Weapon_Spear_132 close */

template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Weapon_Spear_132::State> = murmurhash3::hash("PictureBookData.Weapon_Spear_132.State");