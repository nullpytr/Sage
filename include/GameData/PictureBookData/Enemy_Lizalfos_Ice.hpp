...
template <> struct Data::Structure<GameData::PictureBookData::Enemy_Lizalfos_Ice> : GameData::PictureBookData::Enemy_Lizalfos_Ice {
	...
	{ }
};/* Data::Structure GameData::PictureBookData::Enemy_Lizalfos_Ice close */

template <> hash_t constexpr Data::Hashtable<GameData::PictureBookData::Enemy_Lizalfos_Ice::State> = murmurhash3::hash("PictureBookData.Enemy_Lizalfos_Ice.State");