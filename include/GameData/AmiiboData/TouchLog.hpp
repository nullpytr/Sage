...
template <> struct Data::Structure<GameData::AmiiboData::TouchLog> : GameData::AmiiboData::TouchLog {
	Data::Member<CharacterBaseID> CharacterBaseID;
	Data::Member<CharacterID> CharacterID;
	Data::Member<NumberingID> NumberingID;
