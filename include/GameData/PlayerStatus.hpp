...
struct GameData::PlayerStatus : Tag::Structure {
	struct Companion;
	struct FirstSkyIslandEventFailureOnce : Tag::Member { using type = bool&; using adapter = bool&; };
	struct HasAnyBluePrint : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsEquipShoulderBelt : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsEquipWaistBelt : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsForceDisableSummonCompanion : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsForceDisableUseSpecialPower : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsMasterSwordSleeping : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsUseCameraPointer : Tag::Member { using type = bool&; using adapter = bool&; };
	struct IsUseTemporaryLife : Tag::Member { using type = bool&; using adapter = bool&; };
	struct UseScopeStartEvent : Tag::Member { using type = bool&; using adapter = bool&; };
	struct ZonauEventFailureOnce : Tag::Member { using type = bool&; using adapter = bool&; };
	struct CurrentSpecialPower : Tag::Enum { using type = ::Enum::Scalar<CurrentSpecialPower>; using adapter = ::Enum::Scalar<CurrentSpecialPower>; enum enum_type : hash_t { None = murmurhash3::hash("None"), UltraHand = murmurhash3::hash("UltraHand"), OneTouchBond = murmurhash3::hash("OneTouchBond"), CeilingClipper = murmurhash3::hash("CeilingClipper"), ReverseRecorder = murmurhash3::hash("ReverseRecorder"), AutoBuilder = murmurhash3::hash("AutoBuilder"), SheikahCamera = murmurhash3::hash("SheikahCamera"), Map = murmurhash3::hash("Map"), Amiibo = murmurhash3::hash("Amiibo"), }; };
	struct ParasailPattern : Tag::Enum { using type = ::Enum::Scalar<ParasailPattern>; using adapter = ::Enum::Scalar<ParasailPattern>; enum enum_type : hash_t { Default = murmurhash3::hash("Default"), Pattern00 = murmurhash3::hash("Pattern00"), Pattern01 = murmurhash3::hash("Pattern01"), Pattern02 = murmurhash3::hash("Pattern02"), Pattern03 = murmurhash3::hash("Pattern03"), Pattern04 = murmurhash3::hash("Pattern04"), Pattern05 = murmurhash3::hash("Pattern05"), Pattern06 = murmurhash3::hash("Pattern06"), Pattern07 = murmurhash3::hash("Pattern07"), Pattern08 = murmurhash3::hash("Pattern08"), Pattern09 = murmurhash3::hash("Pattern09"), Pattern10 = murmurhash3::hash("Pattern10"), Pattern11 = murmurhash3::hash("Pattern11"), Pattern12 = murmurhash3::hash("Pattern12"), Pattern13 = murmurhash3::hash("Pattern13"), Pattern14 = murmurhash3::hash("Pattern14"), Pattern15 = murmurhash3::hash("Pattern15"), Pattern16 = murmurhash3::hash("Pattern16"), Pattern17 = murmurhash3::hash("Pattern17"), Pattern18 = murmurhash3::hash("Pattern18"), Pattern19 = murmurhash3::hash("Pattern19"), Pattern20 = murmurhash3::hash("Pattern20"), Pattern21 = murmurhash3::hash("Pattern21"), Pattern22 = murmurhash3::hash("Pattern22"), Pattern23 = murmurhash3::hash("Pattern23"), Pattern24 = murmurhash3::hash("Pattern24"), Pattern25 = murmurhash3::hash("Pattern25"), Pattern26 = murmurhash3::hash("Pattern26"), Pattern27 = murmurhash3::hash("Pattern27"), Pattern28 = murmurhash3::hash("Pattern28"), Pattern29 = murmurhash3::hash("Pattern29"), Pattern30 = murmurhash3::hash("Pattern30"), Pattern31 = murmurhash3::hash("Pattern31"), Pattern32 = murmurhash3::hash("Pattern32"), Pattern33 = murmurhash3::hash("Pattern33"), Pattern34 = murmurhash3::hash("Pattern34"), Pattern35 = murmurhash3::hash("Pattern35"), Pattern36 = murmurhash3::hash("Pattern36"), Pattern37 = murmurhash3::hash("Pattern37"), Pattern38 = murmurhash3::hash("Pattern38"), Pattern39 = murmurhash3::hash("Pattern39"), Pattern40 = murmurhash3::hash("Pattern40"), Pattern41 = murmurhash3::hash("Pattern41"), Pattern43 = murmurhash3::hash("Pattern43"), Pattern45 = murmurhash3::hash("Pattern45"), Pattern46 = murmurhash3::hash("Pattern46"), Pattern48 = murmurhash3::hash("Pattern48"), Pattern49 = murmurhash3::hash("Pattern49"), Pattern51 = murmurhash3::hash("Pattern51"), Pattern52 = murmurhash3::hash("Pattern52"), Pattern53 = murmurhash3::hash("Pattern53"), Pattern55 = murmurhash3::hash("Pattern55"), Pattern56 = murmurhash3::hash("Pattern56"), }; };
	struct CookBuffTime : Tag::Member { using type = float&; using adapter = float&; };
	struct ExtraEnergy : Tag::Member { using type = float&; using adapter = float&; };
	struct ExtraStamina : Tag::Member { using type = float&; using adapter = float&; };
	struct MasterSwordSleepTimer : Tag::Member { using type = float&; using adapter = float&; };
	struct MaxEnergy : Tag::Member { using type = float&; using adapter = float&; };
	struct MaxStamina : Tag::Member { using type = float&; using adapter = float&; };
	struct SavePosRadY : Tag::Member { using type = float&; using adapter = float&; };
	struct TemporaryExtraEnergy : Tag::Member { using type = float&; using adapter = float&; };
	struct TemporaryExtraStamina : Tag::Member { using type = float&; using adapter = float&; };
	struct BreakLife : Tag::Member { using type = s32&; using adapter = s32&; };
	struct CookBuff : Tag::Member { using type = s32&; using adapter = s32&; };
	struct CookBuffLv : Tag::Member { using type = s32&; using adapter = s32&; };
	struct CurrentMamo : Tag::Member { using type = s32&; using adapter = s32&; };
	struct CurrentRupee : Tag::Member { using type = s32&; using adapter = s32&; };
	struct ExtraLife : Tag::Member { using type = s32&; using adapter = s32&; };
	struct Life : Tag::Member { using type = s32&; using adapter = s32&; };
	struct MaxLife : Tag::Member { using type = s32&; using adapter = s32&; };
	struct MaxLifeForBeforeVSGanon : Tag::Member { using type = s32&; using adapter = s32&; };
	struct TemporaryBreakLife : Tag::Member { using type = s32&; using adapter = s32&; };
	struct TemporaryExtraLife : Tag::Member { using type = s32&; using adapter = s32&; };
	struct TemporaryLife : Tag::Member { using type = s32&; using adapter = s32&; };
	struct WeaponAttachCount : Tag::Member { using type = s32&; using adapter = s32&; };
	struct SavePos : Tag::Member { using type = vec3f; using adapter = vec3f*; };
...
template <> struct Data::Structure<GameData::PlayerStatus> : GameData::PlayerStatus {
	...
	FirstSkyIslandEventFailureOnce::type FirstSkyIslandEventFailureOnce;
	HasAnyBluePrint::type HasAnyBluePrint;
	IsEquipShoulderBelt::type IsEquipShoulderBelt;
	IsEquipWaistBelt::type IsEquipWaistBelt;
	IsForceDisableSummonCompanion::type IsForceDisableSummonCompanion;
	IsForceDisableUseSpecialPower::type IsForceDisableUseSpecialPower;
	IsMasterSwordSleeping::type IsMasterSwordSleeping;
	IsUseCameraPointer::type IsUseCameraPointer;
	IsUseTemporaryLife::type IsUseTemporaryLife;
	UseScopeStartEvent::type UseScopeStartEvent;
	ZonauEventFailureOnce::type ZonauEventFailureOnce;
	CurrentSpecialPower::type CurrentSpecialPower;
	ParasailPattern::type ParasailPattern;
	CookBuffTime::type CookBuffTime;
	ExtraEnergy::type ExtraEnergy;
	ExtraStamina::type ExtraStamina;
	MasterSwordSleepTimer::type MasterSwordSleepTimer;
	MaxEnergy::type MaxEnergy;
	MaxStamina::type MaxStamina;
	SavePosRadY::type SavePosRadY;
	TemporaryExtraEnergy::type TemporaryExtraEnergy;
	TemporaryExtraStamina::type TemporaryExtraStamina;
	BreakLife::type BreakLife;
	CookBuff::type CookBuff;
	CookBuffLv::type CookBuffLv;
	CurrentMamo::type CurrentMamo;
	CurrentRupee::type CurrentRupee;
	ExtraLife::type ExtraLife;
	Life::type Life;
	MaxLife::type MaxLife;
	MaxLifeForBeforeVSGanon::type MaxLifeForBeforeVSGanon;
	TemporaryBreakLife::type TemporaryBreakLife;
	TemporaryExtraLife::type TemporaryExtraLife;
	TemporaryLife::type TemporaryLife;
	WeaponAttachCount::type WeaponAttachCount;
	SavePos::type SavePos;
