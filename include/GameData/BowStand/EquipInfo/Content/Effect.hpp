...
struct GameData::BowStand::EquipInfo::Content::Effect : Tag::Structure {
...
};/* Tag::Structure GameData::BowStand::EquipInfo::Content::Effect close */

template <> struct Data::Structure<GameData::BowStand::EquipInfo::Content::Effect> : GameData::BowStand::EquipInfo::Content::Effect {
