...
struct GameData::MaterialShortCut : Tag::Structure {
	struct Category : Tag::Enum { using type = ::Enum::Scalar<Category>; using adapter = ::Enum::Scalar<Category>; enum enum_type : hash_t { Weapon = murmurhash3::hash("Weapon"), Bow = murmurhash3::hash("Bow"), Arrow = murmurhash3::hash("Arrow"), Shield = murmurhash3::hash("Shield"), Armor = murmurhash3::hash("Armor"), Material = murmurhash3::hash("Material"), Food = murmurhash3::hash("Food"), SpecialParts = murmurhash3::hash("SpecialParts"), KeyItem = murmurhash3::hash("KeyItem"), Rupee = murmurhash3::hash("Rupee"), Grain = murmurhash3::hash("Grain"), SpecialPower = murmurhash3::hash("SpecialPower"), }; };
	struct PouchIndex : Tag::Member { using type = s32&; using adapter = s32&; };
