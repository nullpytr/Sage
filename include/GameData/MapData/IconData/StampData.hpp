...
struct GameData::MapData::IconData::StampData : Tag::Structure {
	struct Layer : Tag::Enum { using type = ::Enum::Array<Layer>; using adapter = ::Enum::Array<Layer>; enum enum_type : hash_t { Sky = murmurhash3::hash("Sky"), Ground = murmurhash3::hash("Ground"), Underground = murmurhash3::hash("Underground"), }; };
	struct Type : Tag::Enum { using type = ::Enum::Array<Type>; using adapter = ::Enum::Array<Type>; enum enum_type : hash_t { Invalid = murmurhash3::hash("Invalid"), Sword = murmurhash3::hash("Sword"), Pot = murmurhash3::hash("Pot"), Human = murmurhash3::hash("Human"), Rhombus = murmurhash3::hash("Rhombus"), Heart = murmurhash3::hash("Heart"), Star = murmurhash3::hash("Star"), TreasureBox = murmurhash3::hash("TreasureBox"), Skull = murmurhash3::hash("Skull"), Leaf = murmurhash3::hash("Leaf"), Ore = murmurhash3::hash("Ore"), }; };
	struct Pos : Tag::Member { using type = span<vec2f>; using adapter = adapter<type>*; };
