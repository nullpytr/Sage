...
template <> hash_t constexpr Data::Hashtable<GameData::RecycleBoxData::_18046809928678434263::IsVisit> = murmurhash3::hash("RecycleBoxData.18046809928678434263.IsVisit");