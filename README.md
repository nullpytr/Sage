...
- [mio](https://github.com/vimpunk/mio) - Header-only cross-platform memory-mapped file I/O.
...
- [utfcpp](https://github.com/nemtrif/utfcpp) - Header-only UTF-8/16/32 conversion library. Used for `wstring16` formatting (re-encoding at utf8).
